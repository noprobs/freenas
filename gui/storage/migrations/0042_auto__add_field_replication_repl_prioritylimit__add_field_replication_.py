...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Replication.repl_prioritylimit'
        db.add_column(u'storage_replication', 'repl_prioritylimit',
                      self.gf('django.db.models.fields.IntegerField')(default=-1),
                      keep_default=False)

        # Adding field 'Replication.repl_prioritybegin'
        db.add_column(u'storage_replication', 'repl_prioritybegin',
                      self.gf('django.db.models.fields.TimeField')(default=datetime.time(0, 0)),
                      keep_default=False)

        # Adding field 'Replication.repl_priorityend'
        db.add_column(u'storage_replication', 'repl_priorityend',
                      self.gf('django.db.models.fields.TimeField')(default=datetime.time(23, 59)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Replication.repl_prioritylimit'
        db.delete_column(u'storage_replication', 'repl_prioritylimit')

        # Deleting field 'Replication.repl_prioritybegin'
        db.delete_column(u'storage_replication', 'repl_prioritybegin')

        # Deleting field 'Replication.repl_priorityend'
        db.delete_column(u'storage_replication', 'repl_priorityend')
    ...
    models = {
        ...
        u'storage.replication': {
            ...
            'repl_limit': ('django.db.models.fields.IntegerField', [], {'default': '-1'}),
            'repl_prioritybegin': ('django.db.models.fields.TimeField', [], {'default': 'datetime.time(0, 0)'}),
            'repl_priorityend': ('django.db.models.fields.TimeField', [], {'default': 'datetime.time(23, 59)'}),
            'repl_prioritylimit': ('django.db.models.fields.IntegerField', [], {'default': '-1'}),
